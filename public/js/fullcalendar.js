...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		deleteHtml = '<span class="fc-title">' +
				(htmlEscape(event.title || '') || '&nbsp;') + // we always want one line of height
					'</span>';
			...
			'>' +
				'<div class="fc-content">' +
					(timeText ?
						...
						// this is the available time block id in the db
					...
					(event.title ?
						...
						// // added by alex kwon
						// // adds a remove this particular availability button to each available card. 
						// '<div class="fc-title">' +
						// 	"<button class='closeon'>REMOVE AVAILABILITY</button>"
						// + '</div>' +
